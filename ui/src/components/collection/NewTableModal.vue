...
<div v-if="showNewTableModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
      <div class="bg-white rounded-lg w-1/3 p-6">
        ...
        <div class="mb-4">
          ...
          <input v-model="newTableName" type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
        </div>
        <div class="flex justify-between items-center mb-4">
        ...
        <div class="mb-4">
          ...
          <Button class="w-full bg-white text-gray-700 font-semibold py-2 px-4 border border-gray-300 rounded shadow hover:bg-gray-100">
            + New field
          </Button>
        </div>
        <div class="mb-4">
          <h3 class="text-sm font-medium text-gray-700 mb-2">Unique constraints and indexes (0)</h3>
          <button class="bg-white text-gray-700 text-sm py-1 px-3 border border-gray-300 rounded shadow hover:bg-gray-100">
            + New index
          </button>
        </div>
        <div class="flex justify-end space-x-2">
          ...
          <Button @click='$emit("addTable", newTableName)' class="px-4 py-2 bg-black text-white rounded-md hover:bg-gray-800">
            Create
          </Button >
        </div>
      </div>
